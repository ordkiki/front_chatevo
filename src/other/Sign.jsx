    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post(
                `${apiUrl}/utilisateurs/add`,  // Correction de l'URL
                formData,
                {
                            ...
                            <div className="mt-5 flex flex-col items-center">
                                ...
                                <div className="w-full flex-1 mt-8">
                                    ...
                                    <form onSubmit={handleSubmit} className="mx-auto max-w-xs" method='POST'>
                                        ...
                                        />
                                        <button type='submit' className="mt-5 tracking-wide font-semibold bg-indigo-500 text-gray-100 w-full py-3 rounded-lg hover:bg-indigo-700 transition-all duration-300 ease-in-out flex items-center justify-center focus:shadow-outline focus:outline-none">
                                            <svg
                                            ...
                                            <span className="ml-3">Inscrire</span>
                                        </button>
                                        <p className="mt-6 text-xs text-gray-600 text-center">
                                            j' acceppte la conditions d'utililsation et la confidentialité
